...
//        get the text box
        ...
        WebElement ChoiceField1 = driver.findElement(By.xpath("//input[@data-detail='one' and @name='customField1']"));
        ChoiceField1.sendKeys("How are you");

        WebElement ChoiceField2 = driver.findElement(By.xpath("//input[@data-detail='two' and @name='customField1']"));
        ChoiceField2.sendKeys("This is Field2");
    }
}
